...
function Navbar({ flatDirectories, items }) {
  ...
  return /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement("script", {
    ...
    return /* @__PURE__ */ React8.createElement(Link3, {
      ...
      className: cn3("nextra-nav-link", "underline whitespace-nowrap p-2 -ml-2 hidden md:inline-block", !isActive || page.newWindow ? "text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" : "active text-current font-medium"),
